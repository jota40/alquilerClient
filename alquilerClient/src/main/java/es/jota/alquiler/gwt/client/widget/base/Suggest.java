...
import es.jota.utils.gwt.client.widget.display.SuggestSelection;
import es.jota.utils.gwt.client.widget.display.SuggestSuggestion;
...
public class Suggest extends Composite implements ISuggestSuggestion.Delegate, ISuggestSelection.Delegate, ISelectValue.IDisplay {
	...
	private boolean procesingDropdownClick = false;
	...
	private native void onMouse( Suggest x, Element e )  /*-{
		$wnd.jQuery(e).mouseleave( function() { x.@es.jota.alquiler.gwt.client.widget.base.Suggest::keepFocus = false; } );
		$wnd.jQuery(e).mouseenter( function() { x.@es.jota.alquiler.gwt.client.widget.base.Suggest::keepFocus = true; } );
	}-*/;
	...
	private native void onScroll( Suggest x, Element e )  /*-{
		$wnd.jQuery(e).scroll( function() { x.@es.jota.alquiler.gwt.client.widget.base.Suggest::checkScroll()(); } );
	}-*/;
